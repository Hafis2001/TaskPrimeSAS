      ...
      <View style={styles.container}>
        ...
        <View style={styles.customerCard}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.muted}>{area ? `${area} ΓÇó ${type} ΓÇó ${payment}` : ""}</Text>
          </View>
        </View>
            ...
            return (
              <View style={styles.productCard}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.price}>Γé╣ {item.price.toFixed(2)}</Text>
          ...
          <>
                ...
                return (
                  <View style={styles.cartRow}>
                    <View style={{ flex: 1 }}>
                      ...
                      <Text style={styles.barcode}>Γé╣ {item.product.price.toFixed(2)}</Text>
                      <Text style={styles.itemTotal}>Total: Γé╣ {itemTotal.toFixed(2)}</Text>
                    </View>
            ...
            <View style={styles.cartFooter}>
              <View style={{ marginBottom: 20 }}>
                ...
                <Text style={{ fontSize: 18, fontWeight: "700" }}>Γé╣ {total.toFixed(2)}</Text>
              </View>
